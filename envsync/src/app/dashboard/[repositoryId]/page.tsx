      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-2 text-center text-xs">
            <div className="rounded-md bg-destructive/10 py-2 text-destructive">
              🔴 {data.critical} critical
            </div>
            <div className="rounded-md bg-warning/10 py-2 text-warning">🟡 {data.warning} warnings</div>
            <div className="rounded-md bg-success/10 py-2 text-success">🟢 {data.healthy} healthy</div>
          </div>
